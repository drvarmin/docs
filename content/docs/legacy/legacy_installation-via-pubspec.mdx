---
title: "Flutter - pubspec.yaml (Legacy)"
sidebarTitle: "Flutter - pubspec.yaml"
description: Install the Superwall Flutter SDK via pub package manager. To see the latest release, [check out the repository](https://github.com/superwall/Superwall-Flutter).
---
