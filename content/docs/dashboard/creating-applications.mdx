...
<Frame>![select application](content/docs/images/click-application.png)</Frame>
...
<Frame>![New Project](content/docs/images/new-app.png)</Frame>
</Step>
...
<Frame>
![Start typing](content/docs/images/start-typing.png)
</Frame>
