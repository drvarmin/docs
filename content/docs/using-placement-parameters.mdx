...
- Web Checkout: query string parameters (e.g. `?name=jordan`) are available as placement parameters. See [Web Checkout links](/dashboard/web-checkout/web-checkout-creating-campaigns-to-show-paywalls).
