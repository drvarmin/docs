...
Set up your Stripe or Paddle integration:

- [Stripe Setup](/web-checkout-configuring-stripe-keys-and-settings)

<Note>Paddle is not currently supported this flow, but it does work in app to web scenarios.</Note>
...
- [Creating Campaigns](/web-checkout-creating-campaigns-to-show-paywalls) to show paywalls via  web checkout link. Remember, you use these URLs in any way you wish, but the checkout link itself is derived from two things:

1) The base URL you created for the web app (found in Settings).
